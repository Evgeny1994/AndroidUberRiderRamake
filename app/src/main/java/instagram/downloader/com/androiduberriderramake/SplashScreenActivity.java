...
import instagram.downloader.com.androiduberriderramake.Common.Common;
import instagram.downloader.com.androiduberriderramake.Model.RiderModel;
...
public class SplashScreenActivity extends AppCompatActivity {
   ...
   private DatabaseReference riderInfoRef;
        ...
        btn_continue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (TextUtils.isEmpty(edt_first_name.getText().toString())) {
                    ...
                    riderInfoRef.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue(model)
    ...
    private void goToHomeActivity(RiderModel riderModel) {
        Common.currentRider = riderModel; //Please, don't forget it!!!!
